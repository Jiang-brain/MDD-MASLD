  library(data.table)
  first_diagnosis<-fread("/Users/andyjiang/OneDrive/rtjiang/G/working_data/2024-frailty_Nafld/frailty_nafld.csv",
  ...
  #incorporate death information into the data_censoring table
  ...
  data_censoring$death_reason[death_index]=death_information$death_reason
  rm(death_index)
  ...
  #death
  index_death_wo_diagnosis=which(data_censoring$death>0 & data_censoring$label==0)
  data_censoring$censoring[index_death_wo_diagnosis]=data_censoring$death[index_death_wo_diagnosis]
  data_censoring$label[index_death_wo_diagnosis]=0
